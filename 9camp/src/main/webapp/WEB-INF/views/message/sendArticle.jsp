		...
		<div class="body-main">
			...
			<div class="note-read">
				<table class="table table-border table-article">
					<thead>
						<tr>
							<td class="td-tit">받는사람</td>
							<td class="td-cont">${dto.userNickName} (${dto.msgSenderId})</td>
						</tr>
						<tr>
							<td  class="td-tit">보낸시간</td>
							<td class="td-cont">${dto.msgRegDate}</td>
						</tr>
						<tr>
							<td  class="td-tit">읽은시간</td>
							<td class="td-cont">${dto.msgRead == 0 ? "안 읽음" : dto.msgReadDate}</td>
						</tr>
					</thead>
					<tbody>
						<tr>
				...
				<table class="table">
					<tr>
						<td width="50%">
							<button type="button" class="btn" onclick="sendDelete();">삭제</button>
						</td>
						<td align="right">
							<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/message/listSendMsg.do?${query}';">리스트</button>
						</td>
					</tr>
				</table>
			</div>
